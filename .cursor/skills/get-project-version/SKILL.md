...
description: Resolve a versão atual do front de controle de faturas a partir de version.json e da branch Git. Usar ao criar branch, card Jira, bump de versão ou exibir a versão no footer.
---
