...
import { CategoriasSearch } from "interfaces/Categorias/CategoriasInterface"

export interface CategoriasFilterProps {
    getRemoteCategoriasList: (data: any) => void
}

const CategoriasFilter = ({ getRemoteCategoriasList }: CategoriasFilterProps) => {
    const { handleSubmit, control, register } = useForm<CategoriasSearch>({ defaultValues: {} })
            ...
            <Row>
                <Col xs={12}>
                    <div className="d-flex flex-row justify-content-end align-items-center mb-4">
                        <Link to="/categorias/add" className="btn btn-primary">
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter && (
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemoteCategoriasList)}>
                                ...
                                <Col>
                                    <Collapse isOpen={showFilter} className="multi-collapse mt-3">
                                        <form
                                            ...
                                            id="form-search"
                                            onSubmit={handleSubmit(getRemoteCategoriasList)}
                                        >
                                            <Row>
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="nome" className="form-label">Nome</Label>
                                                        <InputTextControlled<CategoriasSearch>
                                                            field={"nome"}
                                                            control={control}
                                                        />
                                                    </div>
