...
export interface PlataformasTableProps {
    data: PaginateInterface<PlataformasList> | undefined
    getData: (data: PaginateSearch & PlataformasSearch) => void
    setPerPage: (perPage: number) => void
    setPage: (page: number) => void
    page: number
    perPage: number
    filters: PlataformasSearch
}

export const PlataformasTable = ({ data, getData, setPerPage, setPage, perPage, filters }: PlataformasTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            await plataformasService.deletePlataformas(id)
    ...
    return (
        <React.Fragment>
                                                                ...
                                                                <tr key={row.id ?? index}>
                                                                    ...
                                                                    <td>
                                                                        <TableActionsDropdown>
                                                                            <Link to={`/plataformas/view/${row.id}`} state={{ source: row }}>
                                                                                <DropdownItem>Visualizar</DropdownItem>
                                                                            </Link>
                                                                            <Link to={`/plataformas/edit/${row.id}`} state={{ source: row }}>
            ...
            <CustomModal
                ...
                delete={true}
                body="Deseja realmente excluir esta plataforma?"
