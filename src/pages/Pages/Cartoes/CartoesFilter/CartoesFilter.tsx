...
import { CartoesSearch } from "interfaces/Cartoes/CartoesInterface"

export interface CartoesFilterProps {
    getRemoteCartoesList: (data: any) => void
}

const CartoesFilter = ({ getRemoteCartoesList }: CartoesFilterProps) => {
    const { handleSubmit, control, register } = useForm<CartoesSearch>({ defaultValues: {} })
                ...
                <Col xs={12}>
                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                            ...
                            <h4 className="mb-0">Cartões de Crédito</h4>
                        </div>
                        <Breadcrumb pageTitle="" listClassName="mb-sm-0 pt-1 py-2">
                            <BreadcrumbItem><Link to="/dashboard"><i className="ri-home-5-fill"></i></Link></BreadcrumbItem>
                            <BreadcrumbItem active>Cartões de Crédito</BreadcrumbItem>
                        </Breadcrumb>
                    </div>
                </Col>
            </Row>
            ...
            <Row>
                <Col xs={12}>
                    <div className="d-flex flex-row justify-content-end align-items-center mb-4">
                        <Link to="/cartoes/add" className="btn btn-primary">
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter && (
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemoteCartoesList)}>
                                ...
                                <Col>
                                    <Collapse isOpen={showFilter} className="multi-collapse mt-3">
                                        <form
                                            ...
                                            id="form-search"
                                            onSubmit={handleSubmit(getRemoteCartoesList)}
                                        >
                                            <Row>
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="nome" className="form-label">Nome</Label>
                                                        <InputTextControlled<CartoesSearch>
                                                            field={"nome"}
                                                            control={control}
                                                        />
                                                    </div>
