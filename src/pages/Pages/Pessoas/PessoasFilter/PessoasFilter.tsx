...
import { PessoasSearch } from "interfaces/Pessoas/PessoasInterface"

export interface PessoasFilterProps {
    getRemotePessoasList: (data: any) => void
}

const PessoasFilter = ({ getRemotePessoasList }: PessoasFilterProps) => {
    const { handleSubmit, control, register } = useForm<PessoasSearch>({ defaultValues: {} })
                ...
                <Col xs={12}>
                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <Breadcrumb pageTitle="" listClassName="mb-sm-0 pt-1 py-2">
                            ...
                            <BreadcrumbItem active>Pessoas</BreadcrumbItem>
                        </Breadcrumb>
                    </div>
                </Col>
            </Row>
                ...
                <Col xs={12}>
                    <div className="d-flex flex-row justify-content-end align-items-center mb-4">
                        <Link to="add" className="btn btn-primary">
                            <i className="ri-add-circle-line align-middle me-1"></i> Adicionar Pessoa
                        </Link>
                    </div>
                </Col>
                <Col xl={12}>
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter && (
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemotePessoasList)}>
                                ...
                                <Col>
                                    <Collapse isOpen={showFilter} className="multi-collapse mt-3">
                                        <form
                                            ...
                                            id="form-search"
                                            onSubmit={handleSubmit(getRemotePessoasList)}
                                        >
                                            <Row>
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="nome" className="form-label">Nome</Label>
                                                        <InputTextControlled<PessoasSearch>
                                                            field={"nome"}
                                                            control={control}
                                                            placeholder="Nome"
                                                        />
